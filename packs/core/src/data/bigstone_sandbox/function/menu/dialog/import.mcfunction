...
{ \
  ...
  "body": { \
    ...
    "contents": [ \
      ...
      { \
        "translate": "bigstone_sandbox.dialog_menu.saved_hotbars_explain", \
        "color": "gray", \
        "with": [ \
          { \
            "translate": "bigstone_sandbox.dialog_menu.saved_hotbars_click", \
            "color": "blue", \
            "underlined": true, \
            "click_event": { \
              "action": "open_url", \
              "url": "https://www.youtube.com/watch?v=Sz4DkMfvzcQ" \
            }, \
            "hover_event": { \
              "action": "show_text", \
              "value": { \
                "translate": "bigstone_sandbox.dialog_menu.saved_hotbars_hover", \
                "color": "blue", \
              } \
            } \
          } \
