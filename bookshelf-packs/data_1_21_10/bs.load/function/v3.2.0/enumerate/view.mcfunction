...
data modify storage bs:data load.modules append value {module:"bs.view",version:"3.2.0",enabled:0b}
...
execute if score $bs.view.major load.status matches 3 unless score $bs.view.minor load.status matches ..2 run return 0
execute if score $bs.view.major load.status matches 3 if score $bs.view.minor load.status matches 2 unless score $bs.view.patch load.status matches ..0 run return 0
scoreboard players set $bs.view.major load.status 3
scoreboard players set $bs.view.minor load.status 2
