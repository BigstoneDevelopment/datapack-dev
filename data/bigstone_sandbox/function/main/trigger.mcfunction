...
execute if score @s bigstone_menu matches 900 run return run function bigstone_sandbox:dialog_action/options/default_to_components
execute if score @s bigstone_menu matches 901 run return run function bigstone_sandbox:dialog_action/options/info_on_join
execute if score @s bigstone_menu matches 902 run return run function bigstone_sandbox:dialog_action/options/sound_effects
execute if score @s bigstone_menu matches 903 run return run function bigstone_sandbox:dialog_action/options/music
execute if score @s bigstone_menu matches 904 run return run function bigstone_sandbox:dialog_action/options/placement_highlight
