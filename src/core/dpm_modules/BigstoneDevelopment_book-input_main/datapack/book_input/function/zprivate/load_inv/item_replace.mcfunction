...
# replace item
function book_input:zprivate/load_inv/item_replace_macro with storage bigstone_sandbox:input temp.item
...
execute if data storage bigstone_sandbox:input temp.inv[] run function book_input:zprivate/load_inv/item_replace with storage bigstone_sandbox:input temp.inv[-1]