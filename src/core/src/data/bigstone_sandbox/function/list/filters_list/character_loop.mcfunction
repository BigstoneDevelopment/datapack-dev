...
function bigstone_sandbox:list/filters_list/character/lookup with storage bigstone_sandbox:data temp.color
function bigstone_sandbox:list/filters_list/character/concat with storage bigstone_sandbox:data temp.color
