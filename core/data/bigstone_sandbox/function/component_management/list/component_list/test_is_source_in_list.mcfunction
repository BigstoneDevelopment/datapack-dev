...
execute if data storage bigstone_sandbox:data temp.list[0] run return run function bigstone_sandbox:component_management/list/component_list/test_is_source_in_list
return 1