...
#function bigstone_sandbox:component_management/list/filtered_list/get_items with storage xolibs:playerdata storage.bigstone_sandbox.filter
...
function bigstone_sandbox:component_management/list/get_all_personal_components
...
function bigstone_sandbox:component_management/list/filtered_list/mark_saved_components with storage xolibs:playerdata storage

data remove storage bigstone_sandbox:data temp
function bigstone_sandbox:component_management/list/make_private_loaded_list