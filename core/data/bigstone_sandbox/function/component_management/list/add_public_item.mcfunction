...
execute if function bigstone_sandbox:component_management/list/component_list/test_is_uuid_in_list run return run \
  ...
  function bigstone_sandbox:component_management/list/component_list/add_manager_and_make_component_public
...
execute as @a run function bigstone_sandbox:component_management/list/make_private_filtered_list
execute as @a run function bigstone_sandbox:component_management/list/make_filters_lists