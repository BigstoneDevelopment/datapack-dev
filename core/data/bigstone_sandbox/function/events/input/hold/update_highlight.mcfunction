...
execute if score #cast_mode bigstone_sandbox matches 2 run data modify storage bigstone_sandbox highlight set from storage bigstone:settings highlightColour.invalid
