...
data remove storage bigstone_sandbox:data raycast.temp.Data
...
function bigstone_sandbox:grid/clear_highlight with storage bigstone_sandbox:data highlight