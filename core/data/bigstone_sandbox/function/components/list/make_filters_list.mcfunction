...
function bigstone_sandbox:component_management/list/filters_list/sort_and_remove_duplicates
function bigstone_sandbox:component_management/list/filters_list/tags_loop
...
function bigstone_sandbox:component_management/list/filters_list/sort_and_remove_duplicates
function bigstone_sandbox:component_management/list/filters_list/ports_loop
...
function bigstone_sandbox:component_management/list/filters_list/colors_override
