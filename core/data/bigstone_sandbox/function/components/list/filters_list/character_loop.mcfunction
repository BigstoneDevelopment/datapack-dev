...
function bigstone_sandbox:component_management/list/filters_list/character/lookup with storage bigstone_sandbox:data temp.color
function bigstone_sandbox:component_management/list/filters_list/character/concat with storage bigstone_sandbox:data temp.color
