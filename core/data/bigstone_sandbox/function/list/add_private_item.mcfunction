...
data modify storage bigstone_sandbox:data temp.list set from storage xolibs:playerdata storage.bigstone_sandbox.list.components
...
data modify storage xolibs:playerdata storage.bigstone_sandbox.list.components prepend from storage bigstone_sandbox:data temp.component
