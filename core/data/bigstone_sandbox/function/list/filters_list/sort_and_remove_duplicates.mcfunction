...
execute if data storage bigstone_sandbox:data temp.string_sort.mem.queue[0] run function bigstone_sandbox:list/filters_list/string_sort/input_loop with storage bigstone_sandbox:data temp.string_sort.mem
function bigstone_sandbox:list/filters_list/string_sort/input_loop with storage bigstone_sandbox:data temp.string_sort.mem
execute summon item_display run function bigstone_sandbox:list/filters_list/string_sort/item
function bigstone_sandbox:list/filters_list/string_sort/parse with storage bigstone_sandbox:data temp.string_sort.mem
