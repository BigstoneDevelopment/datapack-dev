...
execute as @a[predicate=bigstone_sandbox:triggered_bigstone_sandbox_menu,predicate=bigstone_sandbox:bigstone_sandbox_menu_exists] at @s run function bigstone_sandbox:main/trigger
