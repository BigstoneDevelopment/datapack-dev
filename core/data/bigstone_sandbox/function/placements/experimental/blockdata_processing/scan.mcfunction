say Start
function bigstone_sandbox:blockdata_processing/marker_array/spawn
...
execute as @e[type=marker,tag=bigstone_scan,dx=15,dy=15,dz=15] at @s run function bigstone_sandbox:blockdata_processing/collect_marker_data
