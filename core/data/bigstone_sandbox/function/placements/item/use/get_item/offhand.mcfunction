...
$execute if entity @s[predicate=bigstone_sandbox:item_detect/offhand/is_one,gamemode=!creative] \
    run return \
            run item replace entity @s weapon.offhand with minecraft:music_disc_creator[\
