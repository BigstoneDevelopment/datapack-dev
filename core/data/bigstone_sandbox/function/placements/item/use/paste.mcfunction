...
data modify storage bigstone_sandbox:structures save set from entity @s SelectedItem.components.minecraft:custom_data.bigstone_sandbox.source.structure_data
