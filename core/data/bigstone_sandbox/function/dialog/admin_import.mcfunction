  ...
  "actions": [ \
    { \
      ...
      "action": { \
        ...
        "template": "function bigstone_sandbox:dialog_action/import/private {item_data:'$(item_data)'}" \
      } \
    }, \
    { \
      "label": { \
      ...
      "action": { \
        "type": "dynamic/run_command", \
        "template": "function bigstone_sandbox:dialog_action/import/public {item_data:'$(item_data)'}" \
      } \
    } \
  ] \
}