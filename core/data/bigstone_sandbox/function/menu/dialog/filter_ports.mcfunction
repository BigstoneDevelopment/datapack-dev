tag @s add bigstone_sandbox.last_filter_menu.port
...
data modify storage bigstone_sandbox:data temp.filters.add append from storage bigstone_sandbox:data temp.filters.available[{"type":"port"}]
