...
data modify storage bigstone_sandbox:data temp.filters.add append from storage bigstone_sandbox:playerdata storage.bigstone_sandbox.list.filters[{"type":"creator"}]
