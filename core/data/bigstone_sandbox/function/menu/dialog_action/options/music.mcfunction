...
execute if score bool bigstone_sandbox.temp matches 1 run function bigstone_sandbox:menu/dialog_action/music/stop
execute if score bool bigstone_sandbox.temp matches 0 run function bigstone_sandbox:menu/dialog_action/music/start
