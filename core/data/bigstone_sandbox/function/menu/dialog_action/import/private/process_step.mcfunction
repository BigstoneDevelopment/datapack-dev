...
# run add function
function bigstone_sandbox:components/list/add_private_item

# loop again
data remove storage bigstone_sandbox:data temp.import_list[-1]
execute if data storage bigstone_sandbox:data temp.import_list[] run function bigstone_sandbox:menu/dialog_action/import/private/process_step