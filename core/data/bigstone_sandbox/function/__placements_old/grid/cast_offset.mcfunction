...
execute store result score #targeted_block.x bigstone_sandbox.temp run data get storage bigstone_sandbox:data temp.raycast.Data.x
execute store result score #targeted_block.y bigstone_sandbox.temp run data get storage bigstone_sandbox:data temp.raycast.Data.y
execute store result score #targeted_block.z bigstone_sandbox.temp run data get storage bigstone_sandbox:data temp.raycast.Data.z
...
execute store result storage bigstone_sandbox:data temp.raycast.Data.x int 1 run scoreboard players get #targeted_block.x bigstone_sandbox.temp
execute store result storage bigstone_sandbox:data temp.raycast.Data.y int 1 run scoreboard players get #targeted_block.y bigstone_sandbox.temp
execute store result storage bigstone_sandbox:data temp.raycast.Data.z int 1 run scoreboard players get #targeted_block.z bigstone_sandbox.temp
