...
function bs.structures:zprivate/queue/load/do with storage bigstone_sandbox:structures current
...
execute if data storage bigstone_sandbox:structures queue[0] run function bs.structures:zprivate/queue/load/process