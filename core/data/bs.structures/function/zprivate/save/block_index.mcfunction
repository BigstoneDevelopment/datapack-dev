...
$execute unless data storage bigstone_sandbox:structures anti_index[{block:"$(block)"}] run return run function bs.structures:zprivate/save/new_block with storage bs:out block
