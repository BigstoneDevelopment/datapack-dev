...
execute if score @s bigstone_sandbox.vect_z matches 1.. run return run function bs.structures:zprivate/save/move
execute if score @s bigstone_sandbox.vect_z matches ..0 run function bs.structures:zprivate/save/move_y