...
execute if score @s bigstone_sandbox.vect_y matches 1.. run return run function bs.structures:zprivate/load/move
execute if score @s bigstone_sandbox.vect_y matches ..0 run function bs.structures:zprivate/load/end